        ...
        <form method="post" enctype="multipart/form-data">
            ...
            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                ...
                <tbody>
                    ...
                    $queryGejala = mysqli_query($koneksi, "SELECT * FROM gejala LIMIT $startIndex, $resultsPerPage");

                    while ($data = mysqli_fetch_assoc($queryGejala)) { ?>
                        <tr>
                            <td>
            ...
            <ul class="pagination justify-content-center mt-3">
                <?php
                $totalResults = mysqli_fetch_assoc(mysqli_query($koneksi, "SELECT COUNT(*) as total FROM gejala"))['total'];
