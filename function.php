...
$database = 'db_pernapasananak'; // Ganti dengan nama database Anda
...
function ulang() {
    ...
    // Mengarahkan pengguna ke halaman "test.php"
    header("location: test.php");
    exit(); // Menghentikan eksekusi script setelah mengarahkan header
}
function register()
{
    global $koneksi;
