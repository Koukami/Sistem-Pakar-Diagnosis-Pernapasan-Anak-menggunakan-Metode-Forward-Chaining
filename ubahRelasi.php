...
$queryRelasi = mysqli_query($koneksi, "SELECT * FROM relasi WHERE id_relasi = '$id_relasi'");
$relasi = mysqli_fetch_assoc($queryRelasi);
?>
...
<body>
    ...
    <div class="container-fluid" style="margin-left: 50px;">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                <h1 class="h3 mb-0 text-gray-800">Ubah Data Relasi</h1>
            </div>

            <!-- Content Row -->
            <div class="row">

                <form action="function.php?act=ubahRelasi&id_relasi=<?= $relasi['id_relasi']; ?>" id="ubah" method="POST">
                    <div class="form-group">
                        <label for="id_gejala">ID Gejala</label>
                        <input type="text" class="form-control" id="id_gejala" name="id_gejala" value="<?= $relasi['id_gejala']; ?>">

                        <label for="id_penyakit">ID Penyakit</label>
                        <input type="text" class="form-control" id="id_penyakit" name="id_penyakit" value="<?= $relasi['id_penyakit']; ?>">
                    </div>
