...
$jumlahPakar = mysqli_query($koneksi, "SELECT COUNT('id_user') as jml_pakar FROM user WHERE role='2'");
$pakar = mysqli_fetch_assoc($jumlahPakar);
        ...
        <div class="card-body">
            <div class="row no-gutters align-items-center">
                <div class="col-3 mr-2"> 
                    <img src="gambar/pasien.png" alt="Image Description" class="img-fluid">
                </div>
                <div class="col mr-2">
...
<div class="col-xl-3 col-md-6 mb-4">
    <div class="card border-left-primary shadow h-100 py-2">
        <div class="card-body">
            <div class="row no-gutters align-items-center">
                <div class="col-3 mr-2"> 
                    <img src="gambar/pakar.png" alt="Image Description" class="img-fluid">
                </div>
                <div class="col mr-2">
                    <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Data Pakar</div>
                    <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $pakar['jml_pakar']; ?></div>
                </div>
            </div>
        </div>
    </div>
...
<div class="col-xl-3 col-md-6 mb-4">
    <div class="card border-left-success shadow h-100 py-2">
        <div class="card-body">
            <div class="row no-gutters align-items-center">
            <div class="col-3 mr-2"> 
                    <img src="gambar/penyakit.png" alt="Image Description" class="img-fluid">
                </div>
                <div class="col mr-2">
...
<div class="col-xl-3 col-md-6 mb-4">
    <div class="card border-left-info shadow h-100 py-2">
        <div class="card-body">
            <div class="row no-gutters align-items-center">
            <div class="col-3 mr-2"> 
                    <img src="gambar/gejala.png" alt="Image Description" class="img-fluid">
                </div>
                <div class="col mr-2">
...
<div class="col-xl-3 col-md-6 mb-4">
    <div class="card border-left-warning shadow h-100 py-2">
        <div class="card-body">
            <div class="row no-gutters align-items-center">
            <div class="col-3 mr-2"> 
                    <img src="gambar/solusi.png" alt="Image Description" class="img-fluid">
                </div>
                <div class="col mr-2">
...
<div class="col-xl-3 col-md-6 mb-4">
    <div class="card border-left-warning shadow h-100 py-2">
        <div class="card-body">
            <div class="row no-gutters align-items-center">
            <div class="col-3 mr-2"> 
                    <img src="gambar/relasi.png" alt="Image Description" class="img-fluid">
                </div>
                <div class="col mr-2">
                    <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Data Relasi</div>
                    <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $relasi['jml_relasi']; ?></div>
                </div>
            </div>
        </div>
    </div>
