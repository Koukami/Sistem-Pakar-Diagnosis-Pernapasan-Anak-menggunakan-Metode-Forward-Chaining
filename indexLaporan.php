 ...
 <tr>
                        ...
                        <td>
                            <ol>
                                ...
                                $uniqueSolusiArray = array(); // Membuat array untuk solusi unik

                                foreach ($solusiArray as $solusiItem) {
                                    $solusiNumber = preg_replace('/^[0-9]+\.\s*/', '', $solusiItem); // Menghapus angka awal
                                    $uniqueSolusiArray[$solusiNumber] = $solusiItem;
                                }
                        
                                ksort($uniqueSolusiArray);
